...
public class WineFacadeTest extends AbstractTestNGSpringContextTests {
    ...
    public void init(){
        ...
        veltlinskeZeleneDto = beanMappingService.mapTo(veltlinskeZelene, WineCreateDto.class);
        muskatMoravsky = muskatMoravsky().build();
        muskatMoravskyDto = beanMappingService.mapTo(muskatMoravsky, WineCreateDto.class);
    }
