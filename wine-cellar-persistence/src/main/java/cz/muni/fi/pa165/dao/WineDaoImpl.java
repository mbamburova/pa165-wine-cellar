...
public class WineDaoImpl implements WineDao {
    ...
    public List<Wine> findWinesByName(String name) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.name = :name",
    ...
    public List<Wine> findWinesByVintage(Year vintage) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.vintage = :vintage",
    ...
    public List<Wine> findWinesByPredicate(String predicate) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.predicate = :predicate",
    ...
    public List<Wine> findWinesByPredicateEquivalent(String predicateEquivalent) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.predicateEquivalent = :predicateEquivalent",
    ...
    public List<Wine> findWinesByResidualSugar(BigDecimal from, BigDecimal to) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.alcoholVolume BETWEEN :fromSugar" +
                                    " AND :toSugar",
                            Wine.class)
    ...
    public List<Wine> findWinesByAcidity(BigDecimal from, BigDecimal to) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.alcoholVolume BETWEEN :fromAcidity" +
                                    " AND :toAcidity",
                            Wine.class)
    ...
    public List<Wine> findWinesBetweenYears(Year from, Year to) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.alcoholVolume BETWEEN :fromYear" +
                                    " AND :toYear",
                            Wine.class).setParameter("fromYear", from)
    ...
    public Wine findWineByBatch(String batch) {
            return em.createQuery("SELECT w FROM Wine w WHERE w.batch = :batch",
