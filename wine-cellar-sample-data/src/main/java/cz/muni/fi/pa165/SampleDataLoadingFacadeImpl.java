...
public class SampleDataLoadingFacadeImpl implements SampleDataLoadingFacade {
    ...
    public void loadSampleData() throws IOException {
        ...
        WineList wineList1 = wineList("winelist1", LocalDateTime.of(2016,12,31,22,0), Arrays.asList(veltlinskeZelene, muskatMoravsky, svatovavrinecke), silvester);
        WineList wineList2 = wineList("winelist2", LocalDateTime.of(2017,1,25,0,0), Arrays.asList(veltlinskeZelene, svatovavrinecke), narodeniny);
        WineList wineList3 = wineList("winelist3", LocalDateTime.of(2017,2,10,20,0), Arrays.asList(veltlinskeZelene, muskatMoravsky), betatest);
